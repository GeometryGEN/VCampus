...
public class TestPane extends JPanel {
    ...
    private void addJLabel(){//添加黑名单的内容；
        ...
        jb[0] = new JLabel();
        jb[0].setText("黑名单");
        jb[0].setIcon(new ImageIcon("src/image/student_manage_logo.png"));
        ...
        for(int i=1;i<jb.length;i++){
            jb[i]=new JLabel();
            jb[i].setIcon(new ImageIcon("src/image/student_manage_logo.png"));
