...
public class LoginFrame extends JFrame{
    ...
    public LoginFrame(){
        ...
        ImageIcon icon = new ImageIcon("src/image/Background/bg04.jpg"); // 创建背景图片对象
        ...
        //白色蒙版
        p1 = new JPanel();
        p1.setBounds(10, 30, icon.getIconWidth()-30, icon.getIconHeight()-80);
        ...
        //p2.setBackground(new Color(2, 106, 203 ,180));
        p2.setBackground(new Color(125, 182, 191,200));
        ...
        //中间登录背景
        p3 = new JPanel();
        p3.setBounds(icon.getIconWidth()/2-250, icon.getIconHeight()/2-230, 480, 430);
        p3.setBackground(new Color(125, 182, 191,150));
