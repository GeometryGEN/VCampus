...
public class main_shop {
    ...
    public static void main(String[] args) {
        ...
        btnNewButton_6.setBounds(1030, 75, 100, 40);
        ...
        btnNewButton_7.setBounds(880, 75, 100, 40);
        Font myfont5 = new Font("微软雅黑", Font.PLAIN, 12);
        ...
        btnNewButton_11.setBounds(730, 75, 100, 40);
        Font myfont12 = new Font("微软雅黑", Font.PLAIN, 12);
        ...
        jf.getContentPane().add(btnNewButton_11);
        ...
        jf.getContentPane().add(btnNewButton_10);
