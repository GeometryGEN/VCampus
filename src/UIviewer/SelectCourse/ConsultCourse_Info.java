...
public class ConsultCourse_Info {
    public static void main(String[] args) {
        ...
        touxiang.setBounds(20, 40, 100, 100);
 ...
 */
       ...
       /* JLabel pic1 = new JLabel();
        ...
        btnNewButton_6.setBounds(1030, 55, 100, 30);
        ...
        p1.setBackground(new Color(245, 245, 245, 180));
...
*/
        ...
        ImageIcon icon6 = new ImageIcon("src/image/back1.png");
        l15.setIcon(icon6);
