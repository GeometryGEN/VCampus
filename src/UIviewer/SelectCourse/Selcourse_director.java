...
public class Selcourse_director {
    private JPanel Sel_main;

    public static void main(String[] args) {
        JFrame frame = new JFrame("Selcourse_director");
        frame.setSize(1273, 784);
        //东南大学标志图片
        //文字
        JLabel l1 = new JLabel("欢迎使用东南大学选课系统!");
        l1.setBounds(450, 50, 390, 280);
        ...
        //六个按钮
        // 按钮1
        JButton btnNewButton_1 = new JButton("教师信息管理");
        btnNewButton_1.setBounds(200, 330, 260, 90);
        ...
        btnNewButton_2.setBounds(750, 330, 260, 90);
        ...
        btnNewButton_4.setBounds(200, 530, 260, 90);
        ...
        btnNewButton_5.setBounds(750, 530, 260, 90);
