...
public interface MessageType {
    ...
    String CHECK_BUYED_PRODUCT_NUM="118.1231";
    String CHECK_BUYED_PRODUCT_NUM_SUCCEED="119.1231";     //成功
    String CHECK_BUYED_PRODUCT_NUM_FAILED="120.1231";      //失败
    ...
    String CHECK_READYTOBUY_PRODUCT_NUM="118.111111";
    String CHECK_READYTOBUY_PRODUCT_NUM_SUCCEED="118.211111";     //成功
    String CHECK_READYTOBUY_PRODUCT_NUM_FAILED="118.3111111";      //失败
