...
public interface MessageType {
    ...
    String MESSAGE_LIBRARY_ENTER="21";   //提取用户信息
    String MESSAGE_LIBRARY_ENTER_RET="21.1";//返回提取的用户信息
    String MESSAGE_LIBRARY_ADMIN_LIST="22"; //管理员查看图书馆内书籍
    String MESSAGE_LIBRARY_ADMIN_LIST_RET="22.1";
    String MESSAGE_LIBRARY_LIST_MY_BOOK="22.3";
    String MESSAGE_LIBRARY_LIST_MY_BOOK_RET="22.4";
    String MESSAGE_LIBRARY_ADMIN_HANDLE="23";
    String MESSAGE_LIBRARY_ADMIN_ADD="23.1";
    String MESSAGE_LIBRARY_ADMIN_DELETE="23.2";
    String MESSAGE_LIBRARY_LIST_MY_TICKET="24";
    String MESSAGE_LIBRARY_LIST_MY_TICKET_RET="24.1";
    String MESSAGE_LIBRARY_ADMIN_LIST_TICKETS="25";
    String MESSAGE_LIBRARY_ADMIN_LIST_TICKETS_RET="25.1";
    ...
    String MESSAGE_LIBRARY_QUERY_RET="28.1";
